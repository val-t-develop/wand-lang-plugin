...
public class WandExponentIndicatorImpl extends ASTWrapperPsiElement implements WandExponentIndicator {

  public WandExponentIndicatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitExponentIndicator(this);
  }
