...
public class WandSwitchBlockImpl extends ASTWrapperPsiElement implements WandSwitchBlock {

  public WandSwitchBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WandSwitchBlockStatementGroups getSwitchBlockStatementGroups() {
    return findChildByClass(WandSwitchBlockStatementGroups.class);
  }

  @Override
  @Nullable
  public WandSwitchLabels getSwitchLabels() {
    return findChildByClass(WandSwitchLabels.class);
  }
