...
public class WandSwitchLabelImpl extends ASTWrapperPsiElement implements WandSwitchLabel {

  public WandSwitchLabelImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WandConstantExpression getConstantExpression() {
    return findChildByClass(WandConstantExpression.class);
  }
