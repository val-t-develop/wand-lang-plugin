...
public class WandAssignmentExpressionImpl extends ASTWrapperPsiElement implements WandAssignmentExpression {

  public WandAssignmentExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
