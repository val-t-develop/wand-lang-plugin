...
public class WandLabeledStatementImpl extends ASTWrapperPsiElement implements WandLabeledStatement {

  public WandLabeledStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
