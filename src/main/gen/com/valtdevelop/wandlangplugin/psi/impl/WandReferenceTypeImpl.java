...
public class WandReferenceTypeImpl extends ASTWrapperPsiElement implements WandReferenceType {

  public WandReferenceTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WandClassOrInterfaceType getClassOrInterfaceType() {
    return findNotNullChildByClass(WandClassOrInterfaceType.class);
  }
