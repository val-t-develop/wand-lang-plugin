...
public class WandForUpdateImpl extends ASTWrapperPsiElement implements WandForUpdate {

  public WandForUpdateImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WandStatementExpressionList getStatementExpressionList() {
    return findNotNullChildByClass(WandStatementExpressionList.class);
  }
