...
public class WandShiftExpressionImpl extends ASTWrapperPsiElement implements WandShiftExpression {

  public WandShiftExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WandAdditiveExpression> getAdditiveExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WandAdditiveExpression.class);
  }
