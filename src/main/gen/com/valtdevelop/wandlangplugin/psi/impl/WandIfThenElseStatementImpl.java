...
public class WandIfThenElseStatementImpl extends ASTWrapperPsiElement implements WandIfThenElseStatement {

  public WandIfThenElseStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WandStatement getStatement() {
    return findNotNullChildByClass(WandStatement.class);
  }
