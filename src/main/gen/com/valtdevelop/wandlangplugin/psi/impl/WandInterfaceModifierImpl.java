...
public class WandInterfaceModifierImpl extends ASTWrapperPsiElement implements WandInterfaceModifier {

  public WandInterfaceModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitInterfaceModifier(this);
  }
