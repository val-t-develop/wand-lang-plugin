...
public class WandIntegralTypeImpl extends ASTWrapperPsiElement implements WandIntegralType {

  public WandIntegralTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitIntegralType(this);
  }
