...
public class WandLabeledStatementNoShortIfImpl extends ASTWrapperPsiElement implements WandLabeledStatementNoShortIf {

  public WandLabeledStatementNoShortIfImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitLabeledStatementNoShortIf(this);
  }
