...
public class WandUnaryExpressionImpl extends ASTWrapperPsiElement implements WandUnaryExpression {

  public WandUnaryExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WandUnaryExpressionNotPlusMinus getUnaryExpressionNotPlusMinus() {
    return findChildByClass(WandUnaryExpressionNotPlusMinus.class);
  }
