...
public class WandConstantExpressionImpl extends ASTWrapperPsiElement implements WandConstantExpression {

  public WandConstantExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
