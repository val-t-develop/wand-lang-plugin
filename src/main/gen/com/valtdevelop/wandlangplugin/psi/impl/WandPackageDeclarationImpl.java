...
public class WandPackageDeclarationImpl extends ASTWrapperPsiElement implements WandPackageDeclaration {

  public WandPackageDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
