...
public class WandAndExpressionImpl extends ASTWrapperPsiElement implements WandAndExpression {

  public WandAndExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WandEqualityExpression> getEqualityExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WandEqualityExpression.class);
  }
