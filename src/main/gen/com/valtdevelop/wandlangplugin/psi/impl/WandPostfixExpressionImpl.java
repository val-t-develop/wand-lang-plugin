...
public class WandPostfixExpressionImpl extends ASTWrapperPsiElement implements WandPostfixExpression {

  public WandPostfixExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
