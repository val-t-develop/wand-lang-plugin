...
public class WandClassInstanceCreationExpressionImpl extends ASTWrapperPsiElement implements WandClassInstanceCreationExpression {

  public WandClassInstanceCreationExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitClassInstanceCreationExpression(this);
  }
  ...
  @Override
  @NotNull
  public WandClassType getClassType() {
    return findNotNullChildByClass(WandClassType.class);
  }
