...
public class WandAbstractMethodModifierImpl extends ASTWrapperPsiElement implements WandAbstractMethodModifier {

  public WandAbstractMethodModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitAbstractMethodModifier(this);
  }
