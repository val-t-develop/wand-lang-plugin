...
public class WandLeftHandSideImpl extends ASTWrapperPsiElement implements WandLeftHandSide {

  public WandLeftHandSideImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitLeftHandSide(this);
  }
  ...
  public WandPrimary getPrimary() {
    return findNotNullChildByClass(WandPrimary.class);
  }
