...
public class WandThrowsListImpl extends ASTWrapperPsiElement implements WandThrowsList {

  public WandThrowsListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WandClassTypeList getClassTypeList() {
    return findNotNullChildByClass(WandClassTypeList.class);
  }
