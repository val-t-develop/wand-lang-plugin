...
public class WandExplicitConstructorInvocationImpl extends ASTWrapperPsiElement implements WandExplicitConstructorInvocation {

  public WandExplicitConstructorInvocationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitExplicitConstructorInvocation(this);
  }
