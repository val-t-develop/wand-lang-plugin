...
public class WandResultTypeImpl extends ASTWrapperPsiElement implements WandResultType {

  public WandResultTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WandType getType() {
    return findChildByClass(WandType.class);
  }
