...
public class WandVariableDeclaratorIdImpl extends ASTWrapperPsiElement implements WandVariableDeclaratorId {

  public WandVariableDeclaratorIdImpl(@NotNull ASTNode node) {
    super(node);
  }
