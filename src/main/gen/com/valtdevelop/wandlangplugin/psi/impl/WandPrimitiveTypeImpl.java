...
public class WandPrimitiveTypeImpl extends ASTWrapperPsiElement implements WandPrimitiveType {

  public WandPrimitiveTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WandNumericType getNumericType() {
    return findChildByClass(WandNumericType.class);
  }
