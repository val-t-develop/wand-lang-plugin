...
public class WandLocalVariableDeclarationImpl extends ASTWrapperPsiElement implements WandLocalVariableDeclaration {

  public WandLocalVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
