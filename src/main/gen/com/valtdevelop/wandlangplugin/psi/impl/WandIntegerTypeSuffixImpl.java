...
public class WandIntegerTypeSuffixImpl extends ASTWrapperPsiElement implements WandIntegerTypeSuffix {

  public WandIntegerTypeSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitIntegerTypeSuffix(this);
  }
