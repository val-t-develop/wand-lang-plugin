...
public class WandFieldModifiersImpl extends ASTWrapperPsiElement implements WandFieldModifiers {

  public WandFieldModifiersImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WandFieldModifier> getFieldModifierList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WandFieldModifier.class);
  }
