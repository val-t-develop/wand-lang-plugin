...
public class WandExtendingImpl extends ASTWrapperPsiElement implements WandExtending {

  public WandExtendingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitExtending(this);
  }
