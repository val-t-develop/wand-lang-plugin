...
public class WandWhileStatementNoShortIfImpl extends ASTWrapperPsiElement implements WandWhileStatementNoShortIf {

  public WandWhileStatementNoShortIfImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitWhileStatementNoShortIf(this);
  }
