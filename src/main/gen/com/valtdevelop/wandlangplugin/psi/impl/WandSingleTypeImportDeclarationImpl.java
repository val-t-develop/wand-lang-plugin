...
public class WandSingleTypeImportDeclarationImpl extends ASTWrapperPsiElement implements WandSingleTypeImportDeclaration {

  public WandSingleTypeImportDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WandTypeName getTypeName() {
    return findNotNullChildByClass(WandTypeName.class);
  }
