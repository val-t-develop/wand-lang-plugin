...
public class WandSynchronizedStatementImpl extends ASTWrapperPsiElement implements WandSynchronizedStatement {

  public WandSynchronizedStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
