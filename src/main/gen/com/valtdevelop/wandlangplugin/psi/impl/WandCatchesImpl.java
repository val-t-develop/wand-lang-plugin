...
public class WandCatchesImpl extends ASTWrapperPsiElement implements WandCatches {

  public WandCatchesImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WandCatchClause> getCatchClauseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WandCatchClause.class);
  }
