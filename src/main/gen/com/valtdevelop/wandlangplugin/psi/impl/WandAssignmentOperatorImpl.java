...
public class WandAssignmentOperatorImpl extends ASTWrapperPsiElement implements WandAssignmentOperator {

  public WandAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
