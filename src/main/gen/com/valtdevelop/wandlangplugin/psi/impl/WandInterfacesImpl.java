...
public class WandInterfacesImpl extends ASTWrapperPsiElement implements WandInterfaces {

  public WandInterfacesImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WandInterfaceTypeList getInterfaceTypeList() {
    return findNotNullChildByClass(WandInterfaceTypeList.class);
  }
