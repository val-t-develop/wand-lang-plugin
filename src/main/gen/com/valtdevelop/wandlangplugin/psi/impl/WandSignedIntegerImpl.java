...
public class WandSignedIntegerImpl extends ASTWrapperPsiElement implements WandSignedInteger {

  public WandSignedIntegerImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WandSign getSign() {
    return findChildByClass(WandSign.class);
  }
