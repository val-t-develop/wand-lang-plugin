...
public class WandSwitchStatementImpl extends ASTWrapperPsiElement implements WandSwitchStatement {

  public WandSwitchStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WandSwitchBlock getSwitchBlock() {
    return findNotNullChildByClass(WandSwitchBlock.class);
  }
