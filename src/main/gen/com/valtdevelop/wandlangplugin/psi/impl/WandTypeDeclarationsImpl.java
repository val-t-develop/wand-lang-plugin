...
public class WandTypeDeclarationsImpl extends ASTWrapperPsiElement implements WandTypeDeclarations {

  public WandTypeDeclarationsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WandTypeDeclaration> getTypeDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WandTypeDeclaration.class);
  }
