...
public class WandInterfaceBodyImpl extends ASTWrapperPsiElement implements WandInterfaceBody {

  public WandInterfaceBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WandInterfaceMemberDeclarations getInterfaceMemberDeclarations() {
    return findChildByClass(WandInterfaceMemberDeclarations.class);
  }
