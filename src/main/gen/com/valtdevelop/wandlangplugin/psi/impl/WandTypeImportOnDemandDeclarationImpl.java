...
public class WandTypeImportOnDemandDeclarationImpl extends ASTWrapperPsiElement implements WandTypeImportOnDemandDeclaration {

  public WandTypeImportOnDemandDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WandPackageName getPackageName() {
    return findNotNullChildByClass(WandPackageName.class);
  }
