...
public class WandConstructorModifierImpl extends ASTWrapperPsiElement implements WandConstructorModifier {

  public WandConstructorModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitConstructorModifier(this);
  }
