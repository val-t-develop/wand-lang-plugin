...
public class WandFloatingPointTypeImpl extends ASTWrapperPsiElement implements WandFloatingPointType {

  public WandFloatingPointTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitFloatingPointType(this);
  }
