...
public class WandStaticInitializerImpl extends ASTWrapperPsiElement implements WandStaticInitializer {

  public WandStaticInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WandVisitor visitor) {
    visitor.visitStaticInitializer(this);
  }
