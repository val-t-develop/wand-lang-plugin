...
public class WandContinueStatementImpl extends ASTWrapperPsiElement implements WandContinueStatement {

  public WandContinueStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
