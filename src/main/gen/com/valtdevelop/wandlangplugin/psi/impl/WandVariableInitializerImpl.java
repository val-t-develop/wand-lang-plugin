...
public class WandVariableInitializerImpl extends ASTWrapperPsiElement implements WandVariableInitializer {

  public WandVariableInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WandArrayInitializer getArrayInitializer() {
    return findChildByClass(WandArrayInitializer.class);
  }
