...
public class WandMethodDeclaratorImpl extends ASTWrapperPsiElement implements WandMethodDeclarator {

  public WandMethodDeclaratorImpl(@NotNull ASTNode node) {
    super(node);
  }
