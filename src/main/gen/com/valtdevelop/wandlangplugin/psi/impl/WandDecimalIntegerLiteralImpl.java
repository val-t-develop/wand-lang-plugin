...
public class WandDecimalIntegerLiteralImpl extends ASTWrapperPsiElement implements WandDecimalIntegerLiteral {

  public WandDecimalIntegerLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
